...
/**
 * @description: 
 * @param {char} *key : ascii密钥，如:"1234560avc"
 * @param {char} *in : ascii 字符串，如:"{\"code\":\"00000\",\"Msg\":\"成功\"}"
 ...
 * @description: 将加密后的
 * @param {char} *key : ascii密钥，如:"1234560avc"
 * @param {char} *in： hex字符串，如： 7812452D
...
// void test()
// {
//     const char *in = "abcdefghijklmn";
//     const char *key = "0123456789";
//     unsigned char arrOut[1024] = {0};
//     char out[1024] = {0};
//     int len = string2HexArr(in, strlen(in), arrOut);
//     hexArr2String(arrOut, len, out);
//     printf("len:%d,out:%s\n", len, out);
// }
