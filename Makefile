CC = g++
CC_FLAGS = -W -Wall -Werror -I./  -I/home/xtcgch/Env/redis/redis-6.2.5/deps -L/home/xtcgch/Env/redis/redis-6.2.5/deps/hiredis/build_dir -lhiredis -I/usr/local/include/readerwriterqueue/
EXEC = my_service
